function Cuerpo(){
  ...
  this.cuerpo=new THREE.Mesh(new THREE.CylinderGeometry(2.5, 2.5, 4.5), new THREE.MeshLambertMaterial( { color: 0xdddddd, specular: 0x009900, shininess: 30, shading: THREE.FlatShading } ));
  
  this.BrazoI = new THREE.Mesh(new THREE.CylinderGeometry(0.5,0.5,3.3),new THREE.MeshLambertMaterial({ color: 0xdddddd, specular: 0x009900, shininess: 30, shading: THREE.FlatShading } ));
  this.BrazoD = new THREE.Mesh(new THREE.CylinderGeometry(0.5,0.5,3.3),new THREE.MeshLambertMaterial({ color: 0xdddddd, specular: 0x009900, shininess: 30, shading: THREE.FlatShading } ));
  this.brazI = new THREE.Mesh(new THREE.CylinderGeometry(0.33,0.33,0.4),new THREE.MeshLambertMaterial({ color: 0xdddddd, specular: 0x009900, shininess: 30, shading: THREE.FlatShading } ));
  this.brazD = new THREE.Mesh(new THREE.CylinderGeometry(0.33,0.33,0.4),new THREE.MeshLambertMaterial({ color: 0xdddddd, specular: 0x009900, shininess: 30, shading: THREE.FlatShading } ));
...
function Cabeza(){
  THREE.Object3D.call(this);
  this.cabeza=new THREE.Mesh(new THREE.SphereGeometry(2.5,32,32,0,6.3,0,1.57),new THREE.MeshLambertMaterial({ color: 0xdddddd, specular: 0xFFD700, shininess: 15, shading: THREE.FlatShading } )); //YA
  ...
  this.antena1=new THREE.Mesh(new THREE.CylinderGeometry(0.1,0.1,0.7),new THREE.MeshLambertMaterial({color:0xffffff})); //YA
  this.antena2=new THREE.Mesh(new THREE.CylinderGeometry(0.1,0.1,0.7),new THREE.MeshLambertMaterial({color:0xffffff})); //YA
